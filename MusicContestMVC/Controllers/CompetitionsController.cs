...
namespace MusicContestMVC.Controllers
{
    public class CompetitionsController : Controller
    {
        ...
        public CompetitionsController(MusicContestMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> CompetitionDate()
        {
            return View(await _context.Competition.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Name,dTime")] Competition competition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,dTime")] Competition competition)
        {
